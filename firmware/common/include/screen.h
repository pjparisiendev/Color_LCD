...
/* One cache shared by the dedicated graph page. Changing the selected metric
 * clears history instead of reserving history for every hidden metric. */
extern GraphData g_graphData[1][3];
#endif
